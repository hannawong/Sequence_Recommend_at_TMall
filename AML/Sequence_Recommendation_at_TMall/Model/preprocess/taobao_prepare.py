...
RAW_DATA_FILE = '/data1/jiayu_xiao/project/wzh/MIMN/data/taobao_data/UserBehavior.csv'
DATASET_PKL = '/data1/jiayu_xiao/project/wzh/MIMN/data/taobao_data/dataset.pkl'
Test_File = "/data1/jiayu_xiao/project/wzh/MIMN/data/taobao_data/taobao_test.txt"
Train_File = "/data1/jiayu_xiao/project/wzh/MIMN/data/taobao_data/taobao_train.txt"
Train_handle = open(Train_File, 'w')
Test_handle = open(Test_File, 'w')
Feature_handle = open("/data1/jiayu_xiao/project/wzh/MIMN/data/taobao_data/taobao_feature.pkl",'wb')
